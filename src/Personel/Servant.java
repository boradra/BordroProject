...
public class Servant implements Calisan {
    ...
    public Servant(String id, String isim, String soyisim, Cinsiyet cinsiyet, int brutMaas, int avans, boolean hamilelikDurumu, Cinsiyet cocukCinsiyet, int bebekAylık) {
        this.id = id;
        this.isim = isim;
